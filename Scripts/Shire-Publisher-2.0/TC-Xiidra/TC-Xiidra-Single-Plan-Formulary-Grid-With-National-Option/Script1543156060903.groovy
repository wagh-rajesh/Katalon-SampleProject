...
CustomKeywords.'com.helper.customtemplatehelper.CustomTemplate.scrollToTemplate'('Xiidra Single Plan Formulary Grid with National option')

CustomKeywords.'com.helper.customtemplatehelper.CustomTemplate.selectTemplate'('Xiidra Single Plan Formulary Grid with National option')

WebUI.delay(GlobalVariable.timeoutFiveSec)

CustomKeywords.'com.helper.customtemplatehelper.LocationSelector.selectLocation'('national', GlobalVariable.timeoutTwentySec)
